...
EXPECTED_STANDARD_V8_REFERENCE_KEYS = EXPECTED_STANDARD_V7_REFERENCE_KEYS
EXPECTED_STANDARD_V9_REFERENCE_KEYS = EXPECTED_STANDARD_V8_REFERENCE_KEYS
...
class StandardBootstrapManifest(BaseModel):
    ...
    schema_version: Literal[
        ...
        "standard-control-bootstrap/8.0",
        "standard-control-bootstrap/9.0",
    ...
    def exact_fixed_role_map(self) -> StandardBootstrapManifest:
        ...
        expected_reference_keys = (
            ...
            else EXPECTED_STANDARD_V13_REFERENCE_KEYS
            ...
            else EXPECTED_STANDARD_V10_REFERENCE_KEYS
            if self.schema_version == "standard-control-bootstrap/10.0"
            else EXPECTED_STANDARD_V9_REFERENCE_KEYS
            if self.schema_version == "standard-control-bootstrap/9.0"
            else EXPECTED_STANDARD_V8_REFERENCE_KEYS
            if self.schema_version == "standard-control-bootstrap/8.0"
            else EXPECTED_STANDARD_V7_REFERENCE_KEYS
        ...
        if self.schema_version == "standard-control-bootstrap/8.0" and (
            self.compatible_workflow_protocols != ("workflow-role/1.19.0",)
        ):
            raise ValueError("standard bootstrap V8 protocol differs")
        if self.schema_version == "standard-control-bootstrap/9.0" and (
            self.compatible_workflow_protocols != ("workflow-role/1.19.0",)
        ):
            raise ValueError("standard bootstrap V9 protocol differs")
        if self.schema_version == "standard-control-bootstrap/10.0" and (
            self.compatible_workflow_protocols != ("workflow-role/1.19.0",)
        ):
            raise ValueError("standard bootstrap V10 protocol differs")
        if self.schema_version == "standard-control-bootstrap/11.0" and (
            self.compatible_workflow_protocols != ("workflow-role/1.19.0",)
        ):
            raise ValueError("standard bootstrap V11 protocol differs")
        if self.schema_version == "standard-control-bootstrap/12.0" and (
        ...
        if self.schema_version == "standard-control-bootstrap/14.0" and (
            self.compatible_workflow_protocols != ("workflow-role/1.20.0",)
        ):
            raise ValueError("standard bootstrap V14 protocol differs")
        if self.schema_version == "standard-control-bootstrap/15.0" and (
...
class KnowledgeAnalysisBootstrapManifest(BaseModel):
    ...
    schema_version: Literal[
        ...
        "knowledge-analysis-control-bootstrap/16.0",
    ...
    try:
        ...
        if isinstance(value, dict):
            ...
            contract_name = {
                ...
                "standard-control-bootstrap/8.0": "standard-control-bootstrap-v8",
                "standard-control-bootstrap/9.0": "standard-control-bootstrap-v9",
