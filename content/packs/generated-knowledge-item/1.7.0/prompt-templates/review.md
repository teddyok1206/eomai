...
사용하지 않아야 한다. HYBRID_LOCAL_GENERATIVE에서는 생성 래스터가 사람·생물·복잡한 자연물·현실
장면으로 제한되고 정답 근거의 문자·수치·라벨·척도·기하 구조를 대신하지 않는지 확인하라. 또한
generation_prompt가 대상·자세·배치만 기술하고 실사·사진·상세한 얼굴·피부·3D·그라데이션·그림자·
극적 조명·시네마틱 스타일을 요구하지 않는지 확인하라. GPU 결과는 결정론적 Python/SVG와 같은
순백 배경, 단순화된 익명 인물, 최소 얼굴 표현, 선명한 외곽선, 평면 형태와 제한된 색상이어야 한다.
