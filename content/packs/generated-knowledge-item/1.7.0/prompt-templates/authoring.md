...
장면과 자세만 기술하고 스타일은 지시하지 마라. 특히 실사, 사진, 사실적인 사람, 상세한 얼굴·피부,
3D 렌더, 그라데이션, 그림자, 극적 조명 또는 시네마틱 구도를 요구하지 마라. Catalog adapter가
결정론적 Python/SVG 그림과 동일한 고정 스타일, 즉 순백 배경, 단순화된 익명 인물, 최소한의 얼굴
표현, 선명한 외곽선, 평면 형태와 제한된 평면 색상을 앞에 붙인다. 문자·라벨·숫자·수식·눈금·로고를
