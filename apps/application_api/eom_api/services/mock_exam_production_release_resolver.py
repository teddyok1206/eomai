...
from eom_catalog_contracts.mock_exam_production_plan import MockExamProductionPlanV4
...
class ReleasedMockExamProductionResolver:
    ...
    def __init__(
        ...
        *,
        ...
        self._plan = build_integrated_science_mock_exam_production_plan_v4(
            policy=policy,
    ...
    def production_plan(self) -> MockExamProductionPlanV4:
