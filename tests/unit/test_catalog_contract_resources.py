...
LEGACY_ASSESSMENT_SCHEMA_SHA256 = {
    ...
    "legacy-item-media-pointer-compatibility-policy": (
...
def test_catalog_schema_resources_match_canonical_sources() -> None:
    ...
    assert {
        ...
        "mock-exam-production-plan-v4",
        "mock-exam-production-plan-v5",
        ...
        "catalog-assessment-page-media-response",
