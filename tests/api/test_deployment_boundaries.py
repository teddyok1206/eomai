...
def test_api_release_verifies_knowledge_contract_resources() -> None:
    ...
    for required in (
        ...
        "knowledge/knowledge-analysis-request-v10.schema.json",
        ...
        "knowledge/knowledge-analysis-proposal-receipt-v9.schema.json",
        ...
        "knowledge/knowledge-analysis-result-v10.schema.json",
        "knowledge/knowledge-analysis-worker-proposal-v7.schema.json",
        "knowledge/knowledge-analysis-worker-proposal-v8.schema.json",
        "knowledge/knowledge-analysis-solution-types-v1.schema.json",
        "knowledge/knowledge-analysis-solution-report-v1.schema.json",
        ...
        "knowledge/evidence-bundle-manifest-v5.schema.json",
        ...
        "knowledge/evidence-bundle-publication-result-v5.schema.json",
        ...
        "catalog-application/catalog-application-request-v16.schema.json",
...
def test_release_verifies_mock_exam_production_protocol_resources() -> None:
    ...
    for resource in (
        ...
        "catalog-application-request-v16.schema.json",
...
def test_release_packages_curriculum_graph_capability_api_schema() -> None:
    ...
    assert '"eom_api_contracts/schemas/mock-exam-production-execution-v5.schema.json"' in deployment
    assert (
    ...
    assert 'CURRENT_MIGRATION_REVISION != "20260925_0044"' in deployment
...
def test_release_verifies_content_team_v3_installed_wheel_boundary() -> None:
    ...
    assert '"mock-exam-production-execution/5.0",' in deployment
...
def test_release_verifies_legacy_item_extraction_runtime_and_contracts() -> None:
    ...
    for resource in (
        ...
        "legacy-assessment/legacy-item-media-pointer-compatibility-policy-v1.schema.json",
