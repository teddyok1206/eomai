...
- the manifest Artifact pointer SHA, SHA-256 of the exact canonical newline-terminated bundle
  document bytes, canonical preset manifest SHA, persisted bundle revision manifest SHA, and
  recovery authorization manifest SHA must be byte-identical;
