...
read-only during publication.  A final corpus manifest binds the exact acquisition-manifest hash
and points to each immutable Content Intake source.  Workers never crawl, download, or write the source
