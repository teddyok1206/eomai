#!/usr/bin/env python3
"""Generate additive material-first mock-exam plan and execution schemas."""
...
from eom_api_contracts import MockExamProductionExecutionV4
from eom_catalog_contracts import MockExamProductionPlanV4
...
def main() -> None:
    plan = _schema(
        ...
        "eom://schemas/assessment-assembly/mock-exam-production-plan/4.0",
    )
    _write(
        plan,
    ...
    execution = _schema(
        ...
        "https://eom.local/schemas/api/v1/mock-exam-production-execution-v4.schema.json",
    )
