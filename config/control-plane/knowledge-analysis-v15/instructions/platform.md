...
- Inspect every image supplied through the Codex image-input boundary. Structured Item JSON and OCR
  are auxiliary evidence and never replace mandatory inspection of the page PNGs.
