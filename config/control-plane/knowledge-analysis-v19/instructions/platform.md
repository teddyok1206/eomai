...
- Inspect every image supplied through the Codex image-input boundary when the request includes page
  observations. Structured Item JSON and OCR are auxiliary evidence and never replace required PNG
  inspection.
