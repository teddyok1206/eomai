...
authoring-result@12.0. Before this role invocation, the orchestrator has resolved each selected
...
file is absent or unreadable, fail the role invocation before returning review-result@12.0; never
...
Otherwise return review-result@12.0 without inventing a finding.

Independently solve the authored item rather than assuming its answer and explanation are correct.
Return review-result@12.0 with a bounded `independent_review_report`; never expose free-form hidden
