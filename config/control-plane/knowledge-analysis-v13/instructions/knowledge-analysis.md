# Closed-reference multimodal knowledge-analysis role contract
...
provenance, unique ambiguity observations, and complete ordered page-image observations. Do not
repair a failure by inventing a citation or pointing to an approximate identity.
